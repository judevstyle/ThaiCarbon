...
//                context.getResources(), R.drawable.mypng);
            ...
            scaled.compress(Bitmap.CompressFormat.JPEG,70,stream1);
//        bitmap.compress(Bitmap.CompressFormat.JPEG, 100, stream);
            byte[] imageInByte1 = stream1.toByteArray();
            long lengthbmp1 = imageInByte1.length;

            setImageDrawable(new FastBitmapDrawable(scaled));

        }else if((sizeOf(bitmap)+"").length() > 7){
            int scaleToUse = 30; // this will be our percentage
//        Bitmap bmp = BitmapFactory.decodeResource(
//                context.getResources(), R.drawable.mypng);
            int sizeY = bitmap.getHeight() * scaleToUse / 120;
            ...
            //        Bitmap bitmap = bitmapOrg;
            ByteArrayOutputStream stream1 = new ByteArrayOutputStream();
            scaled.compress(Bitmap.CompressFormat.JPEG,80,stream1);
//        bitmap.compress(Bitmap.CompressFormat.JPEG, 100, stream);
            byte[] imageInByte1 = stream1.toByteArray();
            long lengthbmp1 = imageInByte1.length;
